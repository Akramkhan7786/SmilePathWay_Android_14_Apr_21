...
public class SmileCreditAdapter extends RecyclerView.Adapter<SmileCreditAdapter.ViewHolder> {
    ...
    public SmileCreditAdapter(Activity mContext, onClickItem listner, List<SmilePointsModel.ResultBean.CreditDetailsBean> data) {
